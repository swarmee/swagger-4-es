...
app = FastAPI(
    ...
    ("This Swagger UI page runs through the basic [Elasticsearch](https://www.elastic.co/) API end points (it also works for [Opensearch](https://opensearch.org/) end points). "
     ...
     "Sample payloads and responses have been provided for each endpoint to assist in the learning process. "
     ...
     "[swagger-4-es](https://www.swarmee.net/swagger%204%20es/) page."),
    long_description=(),
